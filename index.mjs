...
// import * as controller from "./src/modules/auth/auth.controller.js"
...
// app.post("/register", validate(RegisterDto), controller.register);
// app.post("/login", validate(LoginDto), controller.login);
